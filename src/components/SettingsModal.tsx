      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-xl max-h-[90vh] flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-slate-900/90 p-6 shadow-2xl backdrop-blur-md"
            id="settings_modal"
          >
            {/* Header */}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
              ...
              {/* Action Buttons */}
              <div className="flex-shrink-0 flex gap-2.5 pt-3.5 border-t border-white/5 mt-2">
                <button
                  type="button"
                  onClick={onClose}
